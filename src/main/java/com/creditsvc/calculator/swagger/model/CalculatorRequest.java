 ...
 */
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen", date = "2021-05-02T19:48:36.232Z[GMT]")
...
public class CalculatorRequest   {
   ...
   * @return companyType
   **/
  @Schema(required = true, description = "Company Type")
      @NotNull
