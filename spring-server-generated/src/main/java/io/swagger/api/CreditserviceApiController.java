...
public class CreditserviceApiController implements CreditserviceApi {
    ...
    public ResponseEntity<List<CalculatorResponse>> addPet(@Parameter(in = ParameterIn.DEFAULT, description = "Pet object that needs to be added to the store", required=true, schema=@Schema()) @Valid @RequestBody CalculatorRequest body) {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                ...
                return new ResponseEntity<List<CalculatorResponse>>(HttpStatus.INTERNAL_SERVER_ERROR);
            }
        }

        return new ResponseEntity<List<CalculatorResponse>>(HttpStatus.NOT_IMPLEMENTED);
    }
